...
describe('total likes', () => {
  ...
  test('when only blog in the list, equals the right amount of likes', () => {
    const result = listHelper.numOfLikes(listWithOneBlog);
    assert.strictEqual(result, 5);
  });

  test('sums the correct amount of likes for an array of blogs', () => {
    const result = listHelper.numOfLikes(blogs);
...
describe('highest likes', () => {
  ...
  test('returns the blog with the highest likes', () => {
    ...
    // Define the expected result (blog object with the highest likes)
    const expected = {
      _id: '5a422b3a1b54a676234d17f9',
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
...
describe('most blogs', () => {
  ...
  test('returns an object with two properties of the author and how many blogs', () => {
